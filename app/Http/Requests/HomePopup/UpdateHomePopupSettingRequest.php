...
class UpdateHomePopupSettingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'whatsappTime1' => ['sometimes', 'integer', 'min:0'],
            'whatsappTime2' => ['sometimes', 'integer', 'min:0'],
            'whatsappTime3' => ['sometimes', 'integer', 'min:0'],
            'whatsapp_time_1' => ['sometimes', 'integer', 'min:0'],
            'whatsapp_time_2' => ['sometimes', 'integer', 'min:0'],
            'whatsapp_time_3' => ['sometimes', 'integer', 'min:0'],
