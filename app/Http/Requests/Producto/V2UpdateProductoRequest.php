    ...
    public function rules(): array
{
    ...
    return [
        ...
        'imagenes_nuevas.*' => 'nullable|file|image|mimes:jpg,jpeg,png,webp|max:3048',
        ...
        'imagenes_editadas.*.file' => 'nullable|file|image|mimes:jpg,jpeg,png,webp|max:3048',
        'imagenes_editadas.*.alt' => 'nullable|string|max:255',
        'imagenes_editadas.*.ttl' => 'nullable|string|max:255',

        // Imagen popup
        'imagen_popup' => 'nullable|file|image|mimes:jpg,jpeg,png,webp|max:3048',
        'texto_alt_popup' => 'nullable|string|max:255',
        'imagen_popup2' => 'nullable|file|image|mimes:jpg,jpeg,png,webp|max:3048',
        'texto_alt_popup2' => 'nullable|string|max:255',

        // Imagen popup mobile
        'imagen_popup_mobile' => 'nullable|file|image|mimes:jpg,jpeg,png,webp|max:3048',
        'texto_alt_popup_mobile' => 'nullable|string|max:255',
        'imagen_popup_mobile2' => 'nullable|file|image|mimes:jpg,jpeg,png,webp|max:3048',
        'texto_alt_popup_mobile2' => 'nullable|string|max:255',
        'imageMobile' => 'nullable|file|image|mimes:jpg,jpeg,png,webp|max:3048',
        'imageMobile2' => 'nullable|file|image|mimes:jpg,jpeg,png,webp|max:3048',
        'popup_mobile_image' => 'nullable|file|image|mimes:jpg,jpeg,png,webp|max:3048',
        'popup_mobile_image2' => 'nullable|file|image|mimes:jpg,jpeg,png,webp|max:3048',
        'popupMobileImageCount' => 'nullable|integer|in:1,2',
        'popup_mobile_image_count' => 'nullable|integer|in:1,2',
        //Imagen email

        'imagen_email' => 'nullable|file|image|mimes:jpg,jpeg,png,webp|max:3048',
        ...
        'imagen_email_1' => 'nullable|file|image|mimes:jpg,jpeg,png,webp|max:3048',
        ...
        'imagen_email_2' => 'nullable|file|image|mimes:jpg,jpeg,png,webp|max:3048',
        ...
        'imagen_email_3' => 'nullable|file|image|mimes:jpg,jpeg,png,webp|max:3048',
        ...
        // Imagen Whatsapp
        'imagen_whatsapp' => 'nullable|file|image|mimes:jpg,jpeg,png,webp|max:3048',
        'imagen_whatsapp_2' => 'nullable|file|image|mimes:jpg,jpeg,png,webp|max:3048',
        'imagen_whatsapp_3' => 'nullable|file|image|mimes:jpg,jpeg,png,webp|max:3048',
